...
client_data= {b'Best team in Basketball?',
              b'Best team in Nba?',
              b'Number of continents in the world?',
              b'Capital of USA?',
              b'Capital of England?'}
...
def plotting():
    ...
    plt.title('Server Performance for Client 2')
    width_size=1
