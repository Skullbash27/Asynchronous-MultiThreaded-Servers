...
def client(host,port):
    ...
    if error_happens:
        ...
        return
    sample=random.sample(list(client_data),5)#Calling the dictionary, any random value is picked up and sent
    for info in sample:
...
def plotting():
    ...
    plt.title('Server Performance for Client 5')
    width_size=1
